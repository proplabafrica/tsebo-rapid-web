<template>
  <div id="layout-app" v-if="checkAuth">
          ...
          <div class="dropdown dropdown-c">
            ...
            >
              <nav class="nav">
                ...
                >
                  <i class="icon ion-shuffle"></i> Procurement
                </a>
                <!-- <a href="#" @mousedown="
                  $router.push('/metrogardensiotsensors/metrogardens/fmview')
                " class="nav-link" v-if="isFMOfMetro">
    ...
    <div class="slim-footer">
      <div class="container">
        <p>Copyright {{ currentYear() }} &copy; All Rights Reserved. Vampfi</p>
        <p>
          Designed and Developed by:
          <a style="color: #1caf9a" target="_blank" href="https://vampfi.com/"
            >Vampfi</a
          >
        </p>
      </div>
