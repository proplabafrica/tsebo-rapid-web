      ...
      >
        <div>
          <div class="card-header" :style="{ backgroundColor: '#e3e7f2' }">
            <h6 class="slim-card-title">Approved Requests</h6>
          </div>
          <div class="container">
            <div
                  ...
                  >
                    ...
                    <td v-if="workRequest.sla">
                      <span
                        ...
                        :class="[
                          `bg-${
                            priorityClasses[workRequest.sla.priority.code]
                          }`,
                        ]"
                      ></span>
                        ...
                        <span
                          ...
                          :class="[
                            `tx-${
                              ...
                              slaData.expectedDuration
                                ? 'success'
                                : 'danger'
                            }`,
                          ]"
                        >
                          {{ getCompletedTimeExpended(workRequest) | shortReadableTime }} /
