...
export default {
  ...
  created() {},
  mounted() {
    this.getTankValue(this.value);
    // jQuery code
    // this.value = this.tankLevel;
  ...
  methods: {
    ...mapActions({
      getTankValue: "iot/tank/getTankValue"
    }),
        ...
        class AnalogTank {
          constructor($this, config) {
            ...
            if (this.tankType !== "tower" && this.tankType !== "round") {
              throw new Error(
                `Unknown Tank Type specified: ${this.tankType}. Should be either 'tower' or 'round'.`
              );
            }
          ...
          drawSvgContainer() {
            ...
            this.bodyGroup = this.svgContainer
              .append("g")
              .attr("id", "body-group")
              .attr(
                "transform",
          ...
          getNewHeight() {
            this.newHeight =
              this.fillValue === null ? 0 : this.gaugeScale(this.fillValue);
          }
          ...
          initTower() {
            ...
            this.backFill = this.bodyGroup
              .append("rect")
              .attr("id", "back-fill");
            this.border = this.bodyGroup.append("rect").attr("id", "border");
            this.behindText = this.bodyGroup
              .append("text")
              .attr("id", "behind-text");
            this.behindArrow = this.bodyGroup
              .append("text")
              .attr("id", "behind-arrow");

            if (this.lookupTableValueEnabled) {
              this.lookupTableValueBehindText = this.bodyGroup
                .append("text")
                .attr("id", "lookup-value-behind-text");
            }

            if (this.changeRateValueEnabled) {
              this.changeRateValueBehindText = this.bodyGroup
                .append("text")
                .attr("id", "change-rate-value-behind-text");
            }

            this.waveGroup = this.bodyGroup
              .append("g")
              .attr("clip-path", this.getUniqUrl(uniqId));
            this.waterFill = this.waveGroup
              .append("rect")
              .attr("id", "water-fill");

            this.overlayText = this.waveGroup
              .append("text")
              .attr("id", "overlay-text");
            this.overlayArrow = this.waveGroup
              .append("text")
              .attr("id", "overlay-arrow");

            if (this.lookupTableValueEnabled) {
              this.lookupTableValueOverlayText = this.waveGroup
                .append("text")
                .attr("id", "lookup-value-overlay-text");
            }

            if (this.changeRateValueEnabled) {
              this.changeRateValueOverlayText = this.waveGroup
                .append("text")
                .attr("id", "change-rate-value-overlay-text");
            }

            this.supportLabelGroup = this.bodyGroup
              .append("g")
              .attr("id", "support-label-group");
            this.supportLabelBg = this.supportLabelGroup
              .append("rect")
              .attr("id", "support-label-bg");
            this.supportLabel = this.supportLabelGroup
              .append("text")
              .attr("id", "overlay-support-label");
            this.topSupportLabel = this.supportLabelGroup
              .append("text")
              .attr("id", "top-overlay-support-label");

            this.topMarkerLabel = this.bodyGroup
              .append("text")
              .attr("id", "top-marker-label");
            this.bottomMarkerLabel = this.bodyGroup
              .append("text")
              .attr("id", "bottom-marker-label");
            this.markerBarGroup = this.bodyGroup
              .append("g")
          ...
          initRound() {
            ...
            this.backFill = this.tankGroup
              .append("ellipse")
              .attr("id", "back-fill");
            this.border = this.tankGroup.append("ellipse").attr("id", "border");
            this.neckBackFill = this.tankGroup
              .append("path")
              .attr("id", "neck-back-fill");
            this.behindText = this.tankGroup
              .append("text")
              .attr("id", "behind-text");
            this.behindArrow = this.tankGroup
              .append("text")
              .attr("id", "behind-arrow");

            if (this.lookupTableValueEnabled) {
              this.lookupTableValueBehindText = this.tankGroup
                .append("text")
                .attr("id", "lookup-value-behind-text");
            }

            if (this.changeRateValueEnabled) {
              this.changeRateValueBehindText = this.tankGroup
                .append("text")
                .attr("id", "lookup-value-rate-behind-text");
            }

            this.waveGroup = this.tankGroup
              .append("g")
              .attr("clip-path", this.getUniqUrl(uniqId));
            this.neckFill = this.waveGroup
              .append("path")
              .attr("id", "neck-fill");
            this.waterFill = this.waveGroup
              .append("ellipse")
              .attr("id", "water-fill");
            this.neckBorder = this.tankGroup
              .append("path")
              .attr("id", "neck-border");
            ...
            if (this.changeRateValueEnabled) {
              this.changeRateValueOverlayText = this.waveGroup
                .append("text")
                .attr("id", "lookup-value-rate-overlay-text");
            }
            ...
            this.topMarker = this.tankGroup
              .append("line")
              .attr("id", "top-marker");
            this.bottomMarker = this.tankGroup
              .append("line")
              .attr("id", "bottom-marker");
            this.topMarkerLabel = this.tankGroup
              .append("text")
              .attr("id", "top-marker-label");
            this.bottomMarkerLabel = this.tankGroup
              .append("text")
              .attr("id", "bottom-marker-label");
            this.markerBarGroup = this.tankGroup
              .append("g")
              .attr("id", "marker-bar-group");
          }
          ...
          setInitialValues() {
            this.lookupTableValueEnabled =
              this.lookupTableValue !== null ? true : false;
            this.changeRateValueEnabled =
              this.changeRateValue !== null ? true : false;

            this.fillColor = this.defaultFillColor;

            this.topMarkerText =
              this.topMarkerText === null
                ? this.fillMaxValue.toString()
                : this.topMarkerText;
            this.bottomMarkerText =
              this.bottomMarkerText === null
                ? this.fillMinValue.toString()
                : this.bottomMarkerText;
            this.topMarkerFontColor =
              this.tankType === "tower" ? "#000" : "#fafafa";
            this.bottomMarkerFontColor =
              this.tankType === "tower" ? "#000" : "#fafafa";
          }
          ...
          calculateDimensions() {
            this.markerLabelWidth = this.getMaxWidth(
              this.topMarkerLabel,
              this.bottomMarkerLabel
            );
            ...
            if (this.tankType === "tower") {
              ...
              if (
                ...
                typeof this.fillPadding === "number" &&
                this.fillPadding !== 0
              ) {
              ...
              this.tankWidth =
                this.width - 2 * (this.borderWidth + this.markerLabelWidth); // this is how wide the tank will draw
              this.tankHeight =
                this.height - this.borderWidth - this.neckHeight; // this is how tall the round part of the tank will draw
          ...
          addThresholdMarkers() {
            let topPixelPosition =
              this.gaugeScale(this.fillMaxValue) + this.borderWidth;
            ...
            if (this.tankType === "round") {
              ...
              let bottomPixelPosition =
                this.gaugeScale(this.fillMinValue) - this.borderWidth;
              this.markerBarGroup
                .append("line")
              ...
              this.markerBar = this.markerBarGroup
                .append("line")
                .attr("id", "marker-bar")
                .attr("x1", 1)
                .attr("x2", 1)
            ...
            this.thresholds.forEach((threshold, i) => {
              ...
              let marker = this.markerBarGroup
                .append("line")
                .datum({
                  yCoord: pixelPosition,
                  strokeWidth: this.markerWidth,
                  x1: -this.markerLength
                })
              ...
              if (this.thresholdMarkers.length > 0) {
                this.thresholdMarkerPositions.push({
                  yCoord:
                    (this.thresholdMarkers[i - 1].datum().yCoord +
                      pixelPosition) /
                    2
                });
              }
          ...
          applyFillAttributes() {
            if (this.tankType === "tower") {
              this.applyAttributes(this.backFill, {
                ...
                transform: `translate(-${(this.tankWidth - this.borderWidth) /
                  2}, -${(this.tankHeight - this.borderWidth) / 2})`
              });
              ...
              this.applyAttributes(this.border, {
                ...
                transform: `translate(-${this.tankWidth / 2}, -${this
                  .tankHeight / 2})`
              });
            } else if (this.tankType === "round") {
              ...
              let bottomRight = `${this.tankRx / 4} ${this.height -
                this.tankRy -
                this.borderWidth / 2}`;

              let topLeft = `-${xCoord} ${(this.tankRy / 8) * 7}`;
              let bottomLeft = `-${this.tankRx / 4} ${this.height -
                this.tankRy -
                this.borderWidth / 2}`;
          ...
          applyTextAttributes() {
            ...
            this.applyAttributes(this.behindArrow, {
              ...
              text: `${
                this.arrowName === null ? this.noArrowName : this.arrowName
              }`
            });
            ...
            this.applyAttributes(this.overlayText, {
              datum: {
                color:
                  this.frontFontColor === null ? "#fff" : this.frontFontColor
              },
              "text-anchor": "middle",
              "font-family": this.fontFamily,
              "font-size": `${this.fontSize}px`,
            ...
            if (this.lookupTableValueEnabled) {
              let lookupTransform = `translate(0, ${this.fontSize / 4 +
                this.lookupTableValueFontSize +
                this.lookupTableValueYOffset})`;
            ...
            if (this.changeRateValueEnabled) {
              let yOffset =
                this.fontSize / 4 +
                this.changeRateValueFontSize +
                this.changeRateValueYOffset;

              if (this.lookupTableValueEnabled) {
                yOffset +=
                  this.lookupTableValueFontSize + this.lookupTableValueYOffset;
              }
          ...
          applyWaveHorizontalAttributes() {
            this.clipDef = `M0 0 Q${this.waveWidth / 2} ${this.amplitude}, ${
              this.waveWidth
            } 0 T${2 * this.waveWidth} 0`;
            var minRequiredClipWidth =
              this.width * 2 + 2 * this.waveWidth + this.borderWidth / 2;
          ...
          tweenWaveHorizontal() {
            let that = this;
            let startHeight =
              (this.tankHeight - this.innerHeight) / 2 - this.amplitude / 2;
            let transformStart = `translate(-${this.width +
              2 * this.waveWidth}, ${startHeight})`;
          ...
          animateFromZero() {
            this.waveClip
              .datum({
                transform: `translate(0, ${this.gaugeScale(this.fillMinValue) +
                  this.amplitude})`
              })
          ...
          calculateColor() {
            this.fillAnimationColor =
              this.fillColor === null ? this.defaultFillColor : this.fillColor;
            this.backFontAnimationColor =
              this.backFontColor === null ? this.fillColor : this.backFontColor;
            this.backArrowAnimationColor =
              this.backArrowColor === null
                ? this.fillColor
                : this.backArrowColor;
          }
          ...
          textFormatter(val) {
            if (this.fillUnit) {
              return `${Number(
                Math.round(parseFloat(val) + "e" + this.decimal) +
                  "e-" +
                  this.decimal
              ).toFixed(this.decimal)} ${this.fillUnit}`;
            }
            return `${Number(
              Math.round(parseFloat(val) + "e" + this.decimal) +
                "e-" +
          ...
          lookupTextFormatter(val) {
            if (this.lookupTableValueUnit) {
              return `${Number(
                Math.round(
                  parseFloat(val) + "e" + this.lookupTableValueDecimal
                ) +
                  "e-" +
                  this.lookupTableValueDecimal
              ).toFixed(this.lookupTableValueDecimal)} ${
                this.lookupTableValueUnit
              }`;
            }
            return `${Number(
              Math.round(parseFloat(val) + "e" + this.lookupTableValueDecimal) +
                "e-" +
                this.lookupTableValueDecimal
            ).toFixed(this.lookupTableValueDecimal)}`;
          }
          ...
          changeRateValueTextFormatter(val) {
            if (this.changeRateValueUnit) {
              return `${Number(
                Math.round(
                  parseFloat(val) + "e" + this.changeRateValueDecimal
                ) +
                  "e-" +
                  this.changeRateValueDecimal
              ).toFixed(this.changeRateValueDecimal)} ${
                this.changeRateValueUnit
              }`;
            }
            return `${Number(
              Math.round(parseFloat(val) + "e" + this.changeRateValueDecimal) +
                "e-" +
                this.changeRateValueDecimal
            ).toFixed(this.changeRateValueDecimal)}`;
          }
            ...
            this.behindText
              ...
              .tween("text", function(d) {
                ...
                let interpolate = d3.interpolate(
                  that.textFormatter(node.textContent),
                  that.textFormatter(that.fillValue)
                );
            ...
            if (this.lookupTableValueEnabled) {
              this.lookupTableValueBehindText
                ...
                .tween("text", function(d) {
                  let node = this;
                  let interpolate = d3.interpolate(
                    that.lookupTextFormatter(node.textContent),
                    that.lookupTextFormatter(that.lookupTableValue)
                  );
            ...
            if (this.changeRateValueEnabled) {
              this.changeRateValueBehindText
                ...
                .tween("text", function(d) {
                  let node = this;
                  let interpolate = d3.interpolate(
                    that.changeRateValueTextFormatter(node.textContent),
                    that.changeRateValueTextFormatter(that.changeRateValue)
                  );

                  return function(t) {
                    node.textContent = that.changeRateValueTextFormatter(
                      interpolate(t)
                    );
                  };
                })
          ...
          calculateArrowPosition() {
            ...
            if (
              this.changeRateValueArrowEnabled &&
              this.changeRateValueEnabled
            ) {
              xOffset =
                this.changeRateValueOverlayText.node().getBBox().width / 2 +
                this.overlayArrow.node().getBBox().width / 2 +
                this.arrowXOffset;
              yOffset =
                this.fontSize / 4 +
                this.changeRateValueFontSize +
              ...
              xOffset =
                this.overlayText.node().getBBox().width / 2 +
                this.overlayArrow.node().getBBox().width +
                this.arrowXOffset;
              yOffset =
                this.overlayArrow.node().getBBox().height / 4 +
                this.arrowYOffset;
            }
          ...
          repositionMarker() {
            let topMarkerLabelTrans = `translate(${this.innerWidth / 2 +
              this.markerLabelXOffset -
              this.markerFontSize / 4}, -${this.innerHeight / 2 -
              this.markerFontSize +
              this.markerLabelYOffset})`;
            let bottomMarkerLabelTrans = `translate(${this.innerWidth / 2 +
              this.markerLabelXOffset -
              this.markerFontSize / 4}, ${this.innerHeight / 2 -
              this.markerFontSize / 4 +
              this.markerLabelYOffset})`;
            ...
            if (this.tankType === "round") {
              let markerBarGroupTrans = `translate(${this.innerWidth / 2 +
                this.markerLength +
                this.markerBarXOffset}, 0)`;
          ...
          repositionSupportLabelGroup() {
            ...
            this.supportLabelGroup.attr(
              "transform",
              `translate(0, ${this.height / 2 -
                this.borderWidth -
                this.supportLabelBgHeight / 2})`
            );
          }
          ...
          repositionSupportLabelBg() {
            ...
            let requiredWidth =
              width + 2 * this.supportLabelPadding + paddingForAesthetic;
            ...
            this.supportLabelBg
              ...
              .attr(
                "transform",
                `translate(-${this.supportLabelBgWidth / 2}, -${this
                  .supportLabelBgHeight / 2})`
              );
          }

          repositionSupportLabel() {
            if (this.dualSupportLabel === true) {
              this.topSupportLabelTrans = `translate(0, ${this
                .supportLabelYOffset + this.topSupportLabelYOffset})`;
              this.supportLabelTrans = `translate(0, ${this
                .supportLabelFontSize + this.supportLabelYOffset})`;
            } else if (this.dualSupportLabel === false) {
              this.supportLabelTrans = `translate(0, ${this
                .supportLabelFontSize /
                2 +
                this.supportLabelYOffset})`;
            }
          ...
          getSupportLabelDimensions() {
            ...
            if (this.dualSupportLabel === true) {
              ...
              height =
                this.supportLabelFontSize -
                this.supportLabelYOffset +
                this.topSupportLabelFontSize -
                this.topSupportLabelYOffset;
            } else if (this.dualSupportLabel === false) {
          ...
          getXCoordOfEllipse(y) {
            return Math.sqrt(
              Math.pow(this.tankRx, 2) *
                (1 - Math.pow(y, 2) / Math.pow(this.tankRy, 2))
            );
          }

          getYCoordOfEllipse(x) {
            return Math.sqrt(
              Math.pow(this.tankRy, 2) *
                (1 - Math.pow(x, 2) / Math.pow(this.tankRx, 2))
            );
          }

          slopeOfLineTangentToEllipse(x, y) {
            return (
              (-x * Math.pow(this.tankRy, 2)) / (y * Math.pow(this.tankRx, 2))
            );
          }
          ...
          updateArrow(options) {
            ...
            if (
              typeof this.behindArrow !== "undefined" &&
              typeof this.overlayArrow !== "undefined"
            ) {
              if ("topFillBackArrowColor" in options) {
                this.topFillBackArrowColor = options.topFillBackArrowColor;
              }
          ...
          hover() {
            d3.select(this.svgContainer.node().parentNode).on(
              "mouseleave",
              () => {
                this.thresholdMarkers.forEach((marker, i) => {
                  this.transitionMarker(
                    marker,
                    this.markerWidth,
                    -this.markerLength
                  );
            ...
            d3.select(this.svgContainer.node().parentNode).on(
              "mousemove",
              () => {
                let yCoord = d3.pointer(this.markerBarGroup.node())[1];
                let locationIndex = this.bisector(
                  this.thresholdMarkerPositions,
                  yCoord
                );
    ...
    changeTank(event) {
      ...
      if (tank == "tank1") {
        this.tank = "tank1";
        this.tankIsChanged = true;
        this.value = 80;
        location.replace("google.com");
        this.$store.commit("iot/tank/setTankValue", this.value);
      } else if (tank == "tank2") {
        this.value = 30;
        this.tank = "tank2";
        this.tankIsChanged = true;
  ...
  watch: {
    rerender: r => {
      "rerender value has been updated", r);
    },
    value: v => {
      "value has been updated", v);
    }
  },
  props: ["tankLevel", "tankIsChanged"]
};
</script>
