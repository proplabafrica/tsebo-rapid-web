        ...
        class AnalogTank {
          ...
          applyFillAttributes() {
            if (this.tankType === "tower") {
              this.applyAttributes(this.backFill, {
                ...
                transform: `translate(-${
                  (this.tankWidth - this.borderWidth) / 2
                }, -${(this.tankHeight - this.borderWidth) / 2})`
              });
              ...
              this.applyAttributes(this.border, {
                ...
                transform: `translate(-${this.tankWidth / 2}, -${
                  this.tankHeight / 2
                })`
              });
            } else if (this.tankType === "round") {
              this.applyAttributes(this.tankGroup, {
                transform: `translate(0, -${
                  this.height / 2 - this.tankRy - this.borderWidth / 2
                })`
              });
              ...
              let bottomRight = `${this.tankRx / 4} ${
                this.height - this.tankRy - this.borderWidth / 2
              }`;

              let topLeft = `-${xCoord} ${(this.tankRy / 8) * 7}`;
              let bottomLeft = `-${this.tankRx / 4} ${
                this.height - this.tankRy - this.borderWidth / 2
              }`;
          ...
          animateFromZero() {
            this.waveClip
              .datum({
                transform: `translate(0, ${
                  this.gaugeScale(this.fillMinValue) + this.amplitude
                })`
              })
          ...
          repositionMarker() {
            ...
            if (this.tankType === "round") {
              let markerBarGroupTrans = `translate(${
                this.innerWidth / 2 + this.markerLength + this.markerBarXOffset
              }, 0)`;
          ...
          repositionSupportLabelBg() {
            ...
            this.supportLabelBg
              ...
              .attr(
                "transform",
                `translate(-${this.supportLabelBgWidth / 2}, -${
                  this.supportLabelBgHeight / 2
                })`
              );
          }
          ...
          repositionSupportLabel() {
            if (this.dualSupportLabel === true) {
              this.topSupportLabelTrans = `translate(0, ${
                this.supportLabelYOffset + this.topSupportLabelYOffset
              })`;
              this.supportLabelTrans = `translate(0, ${
                this.supportLabelFontSize + this.supportLabelYOffset
              })`;
            } else if (this.dualSupportLabel === false) {
              this.supportLabelTrans = `translate(0, ${
                this.supportLabelFontSize / 2 + this.supportLabelYOffset
              })`;
            }
