    ...
    <div class="form-layout">
      <div class="row mg-b-20">
        <div class="form-group col-md-4">
          ...
          <input type="text" class="form-control" name="name" placeholder="Equipment Name" v-model="equipment.name" />
        ...
        <div class="form-group col-md-4">
          ...
          <select v-model="equipment.equipment_capacity_id" class="form-control" name="equipment_capacity_id"
        ...
        <div class="form-group col-md-4">
          ...
          <select v-model="equipment.equipment_brand_id" class="form-control" name="equipment_brand_id"
            :disabled="loadingOptions">
        ...
        <div class="form-group col-md-6">
          ...
          <div class="input-group">
            ...
            <select name="oem_life_cycle_measurement" v-model="equipment.oem_life_cycle_measurement" class="form-control"
              required>
...
export default {
  ...
  methods: {
    ...
    async fetchCategoryProperties() {
      ...
      this.byCategoryIds = [this.equipment.equipment_category_id];
    ...
    async submitEquipment() {
      ...
      try {
        const { unit } = this;
        // this.equipment.name = this.equipment.name;
        ...
        this.toast({
          type: "success",
          title: "Equipment " + this.equipment.code + "Added",
        });
